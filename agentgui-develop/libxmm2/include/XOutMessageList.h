...
#ifndef XOUTMESSAGELIST_H
#define XOUTMESSAGELIST_H
...
class XOutMessageList : public QObject {
...
public:
  ...
  /**
   * Returns a Dom Document representing this out messages list
   */
