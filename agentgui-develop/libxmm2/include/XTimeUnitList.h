...
#ifndef XTIMEUNITLIST_H
#define XTIMEUNITLIST_H
...
class XTimeUnitList : public QObject {
...
public:
   ...
   */
  XTimeUnitList(XEnvironment *parent = 0);

  /**
   * Constructor consuming Dom document representing a list of XTimeUnits
   */

  XTimeUnitList(QDomDocument &dom, XEnvironment * parent);
  ...
  /**
   * Returns a Dom Document representing this timeUnit list.
   */
